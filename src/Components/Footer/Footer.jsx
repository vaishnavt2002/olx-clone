        ...
        <div>
          ...
          <div className="list">
            <ul>
              ...
              <li>
              <img width="150px" src="https://statics.olx.in/external/base/img/playstore.png" alt="Download OLX in the Android Play Store" class="Wn0Dp"/>
              </li>
              <li>
              <img width="150px" src="https://statics.olx.in/external/base/img/appstore.png" alt="Download OLX for iOS in the Apple App Store" class="Wn0Dp"/>
              </li>
